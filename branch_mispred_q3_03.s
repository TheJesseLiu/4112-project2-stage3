...
.L30:
	...
	movzbl	144(%rsp,%rdx), %edx
	andb	3152(%rsp,%rsi), %dl
	movslq	0(%r13,%rax,4), %rsi
	andb	9168(%rsp,%rsi), %dl
	movsbl	%dl, %edx
	addl	%edx, %ecx
.LVL91:
.L29:
