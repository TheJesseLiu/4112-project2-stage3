	.file	"branch_mispred_q3_04_v2.c"
	.text
.Ltext0:
...
perf_event_open:
.LFB91:
	.file 1 "branch_mispred_q3_04_v2.c"
	.loc 1 39 0
	.cfi_startproc
.LVL0:
	subq	$8, %rsp
...
.LC11:
	.string	"Loop start!"
.LC13:
	.string	"branch_mispred_q3_04_v2.c"
.LC14:
	.string	"rc"
.LC15:
	.string	"Loop stop!"
...
.LVL76:
	.loc 1 137 0
#APP
# 137 "branch_mispred_q3_04_v2.c" 1
	nop;
# 0 "" 2
.LVL77:
#NO_APP
...
.LBE173:
	...
	.loc 1 142 0
#APP
# 142 "branch_mispred_q3_04_v2.c" 1
	nop;
# 0 "" 2
#NO_APP
	xorl	%edx, %edx
...
.L29:
	...
	movl	%edx, (%rbx,%rax,4)
	.loc 1 150 0 discriminator 3
	movslq	0(%rbp,%rdx,4), %rax
	movzbl	144(%rsp,%rax), %eax
	andb	3152(%rsp,%rsi), %al
	movslq	(%r14,%rdx,4), %rsi
	andb	6160(%rsp,%rsi), %al
	movslq	0(%r13,%rdx,4), %rsi
	addq	$1, %rdx
.LVL90:
	andb	9168(%rsp,%rsi), %al
	movsbl	%al, %eax
	addl	%eax, %ecx
.LVL91:
	...
	.loc 1 154 0
#APP
# 154 "branch_mispred_q3_04_v2.c" 1
	nop;
# 0 "" 2
.LVL92:
#NO_APP
...
.LBE181:
	...
	.loc 1 160 0
#APP
# 160 "branch_mispred_q3_04_v2.c" 1
	nop;
# 0 "" 2
	.loc 1 163 0
#NO_APP
...
.LASF187:
	.string	"puts"
.LASF206:
	.string	"/home/yz3054/4112-project2-stage3"
.LASF139:
	.string	"comm_exec"
.LASF12:
	.string	"sizetype"
