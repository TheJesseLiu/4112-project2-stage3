...
# 160 "branch_mispred.c" 3 4
                                               ((
# 160 "branch_mispred.c"
                                               rc
# 160 "branch_mispred.c" 3 4
                                               ) ? (void) (0) : __assert_fail (
# 160 "branch_mispred.c"
                                               "rc"
# 160 "branch_mispred.c" 3 4
                                               , "branch_mispred.c", 160, __PRETTY_FUNCTION__))
# 160 "branch_mispred.c"
                                                         ;
  
# 161 "branch_mispred.c" 3 4
 ((
# 161 "branch_mispred.c"
 rc
# 161 "branch_mispred.c" 3 4
 ) ? (void) (0) : __assert_fail (
# 161 "branch_mispred.c"
 "rc"
# 161 "branch_mispred.c" 3 4
 , "branch_mispred.c", 161, __PRETTY_FUNCTION__))
# 161 "branch_mispred.c"
           ;
  asm volatile ("nop;");
...
double get_timestamp(double start_time) {
  ...
  if (gettimeofday(&tp, 
# 211 "branch_mispred.c" 3 4
                       ((void *)0)
# 211 "branch_mispred.c"
                           ) == 0) {
...
# 230 "branch_mispred.c" 3 4
                                   2147483647
# 230 "branch_mispred.c"
                                           ) + (double)(1)));
    if(r < selectivity) {
      *data = 1;
    } else {
...
# 251 "branch_mispred.c" 3 4
                                          2147483647
# 251 "branch_mispred.c"
                                                  ) + (double)(1)));
